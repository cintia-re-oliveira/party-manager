...
<div class="col-lg-8 col-lg-offset-2 text-center">
    <h2 class="margin-top-0 wow fadeIn">LISTA DE PRODUTOS</h2>
    <hr class="primary">
</div>
      ...
      <td> Remover </td>
		...
		@foreach ($produtos as $p)
			<tr class="{{$p->quantidade<=1 ? 'danger' : '' }}">
				...
				<td>{{ $p->descricao }} </td>
				<td>{{ $p->quantidade }} </td>
				<td align=center><a href="/produtos/mostra/{{ $p->id }}"><i class="glyphicon glyphicon-list-alt"></i></a></td>
				<td align=center>
					<a href="{{action('ProdutoController@remove', $p->id)}}"><i class="glyphicon glyphicon-trash"></i></a>
				</td>
			</tr>
		@endforeach
	</table>
