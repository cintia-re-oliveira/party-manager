...
<div class="col-lg-8 col-lg-offset-2 text-center">
    <h2 class="margin-top-0 wow fadeIn"> CONFIGURAÇÕES </h2>
    <hr class="primary">
</div>

<table class="table table-bordered table-hover">
	<tr>
		<td><a href="/usuarios/novo">Usuários</a> </td>
	</tr>
	<tr>
		<td><a href="/promocoes/novo">Promoções</a> </td>
	</tr>
	<tr>
		<td><a href="/fotos/novo">Fotos</a> </td>
	</tr>
	<tr>
		<td><a href="/salao/novo">Salão</a> </td>	
	</tr>
