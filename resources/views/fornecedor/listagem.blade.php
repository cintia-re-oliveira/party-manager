...
@if(empty($fornecedores))
	<div class="alert alert-danger">
		Você não tem nenhum fornecedor cadastrado.
	</div>
@else

<div class="col-lg-8 col-lg-offset-2 text-center">
    <h2 class="margin-top-0 wow fadeIn">LISTA DE FORNECEDORES</h2>
    <hr class="primary">
</div>
      ...
      <td> Remover </td>
		...
		@foreach ($fornecedores as $p)
			<tr>
				...
				<td align=center><a href="/fornecedores/mostra/{{ $p->id }}"><i class="glyphicon glyphicon-list-alt"></i></a></td>
				<td align=center>
					<a href="{{action('FornecedorController@remove', $p->id)}}"><i class="glyphicon glyphicon-trash"></i></a>
				</td>
			</tr>
		@endforeach
	</table>
