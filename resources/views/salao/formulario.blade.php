...
<ul class="breadcrumb">
  ...
  <li class="active">Cadastro de Salão</li>
</ul>


<div class="col-lg-8 col-lg-offset-2 text-center">
    <h2 class="margin-top-0 wow fadeIn">CADASTRO DE SALÃO</h2>
    <hr class="primary">
</div>

<div class="col-lg-10 col-lg-offset-1 text-center">
	<form action="/salao/adiciona" method="post" class="contact-form row">
		...
		<div class="col-md-4">
			<label></label>
			<input type="text" name="inscricaoestadual" class="form-control" placeholder="Insc. Estadual">
		</div>
		<div class="col-md-4">
			<label></label>
