...
<div class="col-lg-8 col-lg-offset-2 text-center">
    <h2 class="margin-top-0 wow fadeIn">LISTA DE USUÁRIOS</h2>
    <hr class="primary">
</div>
      ...
      <td> Remover </td>
		...
		@foreach ($usuarios as $p)
			<tr>
				...
				<td>{{ $p->senha }} </td>
				<td>{{ $p->tipo }} </td>
				<td align=center><a href="/usuarios/mostra/{{ $p->id }}"><i class="glyphicon glyphicon-list-alt"></i></a></td>
				<td align=center>
					<a href="{{action('UsuarioController@remove', $p->id)}}"><i class="glyphicon glyphicon-trash"></i></a>
				</td>
			</tr>
		@endforeach
	</table>
